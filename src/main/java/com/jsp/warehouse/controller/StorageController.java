...
public class StorageController {
	...
	private ResponseEntity<SimpleResponseStructure<String>> addStorage(@RequestBody StorageRequest stroageRequest,@PathVariable int warehouseId,@RequestParam("no_of_storage_units") int noOfStorageUnits){
